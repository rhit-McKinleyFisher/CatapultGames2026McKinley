...
class Hero:
    def __init__(self, screen: pygame.Surface, x, y, with_umbrella_filename, without_umbrella_filename):
        ...
        self.x = x
        self.y = y
        self.image_umbrella = pygame.image.load(os.path.join(BASE_DIR, with_umbrella_filename))
        self.image_no_umbrella = pygame.image.load(os.path.join(BASE_DIR, without_umbrella_filename))
