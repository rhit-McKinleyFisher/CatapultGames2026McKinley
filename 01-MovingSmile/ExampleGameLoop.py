...
# DONE 05: Change the window size, make sure your circle code still works.
...
while True:
    ...
    pygame.draw.circle(screen, pygame.Color("Dark Blue"), (100, 100), 25)
    ...
    pygame.draw.circle(screen, pygame.Color(255, 255, 0), (0, 800), 100)
